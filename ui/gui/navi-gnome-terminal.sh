...
[[ -z "$PROFILE_NAME" ]] && PROFILE_NAME="Navi"
[[ -z "$PROFILE_SLUG" ]] && PROFILE_SLUG="navi"
[[ -z "$DCONF" ]] && DCONF=dconf
[[ -z "$UUIDGEN" ]] && UUIDGEN=uuidgen


NAVI_GNOME_TERMINAL_VERSION=0.1.0
...
unset DCONF
unset UUIDGEN
unset NAVI_GNOME_TERMINAL_VERSION
